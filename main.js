...
boutonStart.addEventListener("click", function () {
    ...
    btnInv1.addEventListener("click", function () {
        ...
        boutonSubmit.addEventListener("click",function(){
            ...
            addBtnImg("imgAvatarContainer","./assets/icons/journal.png","perso1");
            addBtnImg("imgAvatarContainer","./assets/icons/journal.png","perso2");
            addBtnImg("imgAvatarContainer","./assets/icons/journal.png","perso3");
