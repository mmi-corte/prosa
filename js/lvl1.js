...
export function loadLvl1() {
    ...
    const steps = [
        ...
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Berger", character: 'assets/personnages/berger V1 premier plan.png', name: 'E1Berger' },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Narra1", character: null },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Berger1", character: 'assets/personnages/berger V1 premier plan.png', name: 'E1Berger1' },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Narra2", character: null },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Berger2", character: 'assets/personnages/berger V1 premier plan.png', name: 'E1Berger2' },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Narra3", character: null },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Berger3", character: 'assets/personnages/berger V1 premier plan.png', name: 'E1Berger3' },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Narra4", character: null },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Berger4", character: 'assets/personnages/berger V1 premier plan.png', name: 'E1Berger4' },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Narra5", character: null },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Berger5", character: 'assets/personnages/berger V1 premier plan.png', name: 'E1Berger5' },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Narra6", character: null },
        { background: 'assets/bg/fondEtape1.mp4', narration: "E1Berger6", character: 'assets/personnages/berger V1 premier plan.png', name: 'E1Berger6' },
        {
