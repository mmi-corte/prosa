...
export function loadScreen1(){
  ...
  addTxt(
    "container",
    `Afin de vivre une bonne expérience, utilisez un smartphone avec suffisamment de batterie pour pouvoir scanner les qr codes pour une immersion maximale.`,
    "txt",
    "screen1style"
  );
  addImg("container", "../assets/icons/clic.png", "screen1style", "");
  addTxt(
    "container",
    `Lors des séquences de narration, touchez avec votre doigt sur la partie inférieure droite de l’écran pour passer à l’étape suivante.`,
    "txt",
    "screen1style"
  );
  addSVG(
...
export function loadScreen2() {
  ...
  btnCorte.addEventListener("click", function () {
    ...
    console.log("Ville choisie : Corte");
    // Vous pouvez ensuite charger une autre page ou procéder à d'autres actions
    console.log("Cookie ville : ", getCookie("ville"));
  });
  ...
  btnToulon.addEventListener("click", function () {
    ...
    console.log("Ville choisie : Toulon");
    // Vous pouvez ensuite charger une autre page ou procéder à d'autres actions
    console.log("Cookie ville : ", getCookie("ville"));
  });
