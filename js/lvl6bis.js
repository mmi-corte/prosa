...
export function loadLvl6bis() {
      ...
      const steps = [
        ...
        { background: 'assets/bg/fondEtape6bis.png', narration: "E6Berger", character: 'assets/personnages/berger.png', name: 'E6Berger' },
        { background: 'assets/bg/fondEtape6bis.png', narration: "E6Narra2", character: null },
        { background: 'assets/bg/fondEtape6bis.png', narration: "E6Berger2", character: 'assets/personnages/berger.png', name: 'E6Berger2',
            choices: [
