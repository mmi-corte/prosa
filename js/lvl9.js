...
export function loadLvl9() {
   ...
   const steps = [
    ...
    { background: 'assets/bg/fondEtape9.mp4', narration: "E9Berger", character: 'assets/personnages/Berger/berger.png', name: 'E3Berger' },
    { background: 'assets/bg/fondEtape9.mp4', narration: "E9Narra2", character: null },
    { background: 'assets/bg/fondEtape9.mp4', narration: "E9Berger2", character: 'assets/personnages/Berger/berger.png', name: 'E3Berger1' },
    { background: 'assets/bg/fondEtape9.mp4', choices: [ { text: "E9Mess", action: loadLvl10 } ], character: null , },
];
